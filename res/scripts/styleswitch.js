...
if (window.mobileCheck()) {
    ...
    if (date > 320 && date < 621) {
        ...
        document.getElementById("style").setAttribute("href", "res/styles/summer_m.css");
    } else if (date > 920 && date < 1221) {
        document.getElementById("style").setAttribute("href", "res/styles/fall_m.css");
    } else if (date > 1220 && date < 321) {
        document.getElementById("style").setAttribute("href", "res/styles/winter_m.css");
    } else {
